...
```
Essa é uma implementação concreta (ConcreteStrategy) de movimento padrão. O método executar é responsável por mover o objeto com base nas teclas de direção pressionadas. Ele também atualiza a escala do sprite e define o sprite do personagem com base na tecla pressionada.
<br>
...
```
Essa é outra implementação concreta (ConcreteStrategy) de movimento aleatório. O método executar é que implementa o algoritmo de movimento aleatório para inimigos.
<br>
